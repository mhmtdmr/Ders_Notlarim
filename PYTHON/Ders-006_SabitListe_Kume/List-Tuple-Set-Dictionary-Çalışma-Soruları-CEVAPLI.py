...
for key in sozluk: 
    ...
    print(sozluk[key])
    """
    sozluk[key]=input(key,"kelimesinin türkçesi nedir?:")
print(sozluk)
"""
...
# 3 boyutlu dizi tanımalamaya örnek:
r = 3
c = 4
d = 5

array = [[ [ r+h+s for r in range(d)] for h in range(c)] for s in range(r)]
print(array[1][2][2])
